    ...
    >
        ...
        <div class="card-cont">
          <el-form label-position="left" size="mini" label-suffix=":" label-width="45px">
            ...
            <el-form-item label="名称">
              <el-input v-model="item.conditionName" placeholder="请输入名称" clearable />
            </el-form-item>
            <el-form-item label="必填">
              <el-checkbox v-model="item.required" label="必填" border />
            </el-form-item>
          </el-form>
        </div>
      </el-card>
      <el-card class="card" :body-style="{ padding: '0px' }">
        <div class="card-cont2">
          <el-button type="small" icon="el-icon-circle-plus" title="添加条件" @click="add()">添加条件</el-button>
        </div>
      </el-card>
    </draggable>
  </div>
